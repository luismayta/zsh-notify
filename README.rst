...
2. Clone the plugin
   ``bash   git clone https://github.com/luismayta/zsh-notify``\ bash
3. Edit your ``.zshrc`` and add
   ``plugins=( ... zsh-notify )`` to your list of
   plugins
...
1. Add ``antibody bundle luismayta/zsh-notify`` to your
   ``.zshrc`` where you're adding your other plugins.
2. Either open a new terminal to force zsh to load the new plugin, or
   run ``antibody bundle luismayta/zsh-notify`` in a
   running zsh session.
3. Enjoy!
...
.. |Build Status| image:: https://travis-ci.org/luismayta/zsh-notify.svg
   :target: https://travis-ci.org/luismayta/zsh-notify
.. |GitHub issues| image:: https://img.shields.io/github/issues/luismayta/zsh-notify.svg
   :target: https://github.com/luismayta/zsh-notify/issues
